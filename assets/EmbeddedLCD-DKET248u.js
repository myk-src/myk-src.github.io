import{d as u,o as d,c as l,a as n,F as i,r,b as e,t as o,g as c,n as p,_ as v}from"./index-Cl5m8_-u.js";const b={class:"breadboard"},k={class:"power-rail red-rail"},y={class:"breadboard-body"},w={class:"embedded-lcd"},g={class:"lcd-bezel"},E={class:"lcd-screen"},N={class:"comment"},f={class:"comment"},C={class:"comment"},O={class:"comment"},D={class:"comment"},S={class:"comment"},j={class:"comment"},x={class:"comment"},B={class:"pins top-pins"},F={class:"pins bottom-pins"},I={class:"hole-grid"},L={class:"power-rail blue-rail"},R=u({__name:"EmbeddedLCD",props:{resume:{},isFocused:{type:Boolean}},setup(t){return(T,s)=>(d(),l("section",{class:p(["physical-object breadboard-assembly",{focused:t.isFocused}])},[n("div",b,[n("div",k,[(d(),l(i,null,r(30,a=>n("div",{class:"hole",key:"r"+a})),64))]),n("div",y,[n("div",w,[n("div",g,[n("div",E,[s[16]||(s[16]=n("div",{class:"scanline"},null,-1)),n("pre",null,[n("code",null,[s[0]||(s[0]=n("span",{class:"kw"},"module",-1)),s[1]||(s[1]=e()),s[2]||(s[2]=n("span",{class:"fn"},"myk_system_arch",-1)),s[3]||(s[3]=e(` (
